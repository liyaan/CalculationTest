...
import com.liyaan.calculationtest.databinding.FragmentLoseBinding
...
class LoseFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding: FragmentLoseBinding = DataBindingUtil.inflate(inflater,
                R.layout.fragment_lose,container,false)
        binding.data = mViewModel
        binding.lifecycleOwner = requireActivity()
        binding.button13.setOnClickListener {
            val controlle = Navigation.findNavController(it)
            controlle.navigate(R.id.action_loseFragment_to_tiltleFragment)
        }
        return binding.root
    }
